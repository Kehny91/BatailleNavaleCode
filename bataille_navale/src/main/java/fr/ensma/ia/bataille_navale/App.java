...
public class App extends Application
{
	...
	public void start(Stage primaryStage) throws Exception {
		j1 = new JoueurHumain("Marin d'eau douce");
		j2 = new JoueurHumain("Capitaine Nemo");
        ...
        Scene j1Toj2Scene = new Scene(new TransitionScreen("C'est au tour de " + j2.getName()) , Parametres.widthPix, Parametres.heightPix);
        Scene j2Toj1Scene = new Scene(new TransitionScreen("C'est au tour de " + j1.getName()) , Parametres.widthPix, Parametres.heightPix);
