...
import fr.ensma.ia.bataille_navale.noyau.actions.attaques.AttaqueCroix;
...
public class AttaqueCroixFactory extends ActionFactory {
	AttaqueCroix out;
	Grille grilleAttaquant,grilleCible;
	
	public AttaqueCroixFactory(IAsker asker, Grille grilleAttaquant, Grille grilleCible) {
		this.asker = asker;
		this.grilleAttaquant = grilleAttaquant;
		this.grilleCible = grilleCible;
		out = new AttaqueCroix();
	}
